...
public class TestNewAccountClass extends NewAccountClass {

	public static void main(String[] args) {

		// Create an Account object
		NewAccountClass account = new NewAccountClass("George", 1122, 1000);

		// Set annual interest rate to 1.5%
		account.set_annualInterestRate(1.5);
		...
		System.out.println("Interest rate: " + account.get_annualInterestRate());
